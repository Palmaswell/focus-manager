...
describe('focus actions', () => {
  ...
  function TestListBoxItem(props: TestListBoxItemProps): JSX.Element {
    return (
      <FocusElement>
        {ctx => (
          <li
  ...
  test('ListBox behaviour actions', () => {
    ...
    const listBox = dom.getByTestId('listbox');
    expect(listBox.getAttribute('aria-activedescendant')).toBeNull();
    simulateKeyDown(dom, 'listbox');
